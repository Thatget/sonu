    ...
    public function execute()
    {
        ...
        try {
			...
			foreach ($productInfo as $item){
			   $listProductId[] = (int)$item->getProductId();

			}
			
			$isBundleProduct = $product->getTypeId() === Type::TYPE_CODE;

			//if ($isBundleProduct && (!isset($params['bundle_option'])) && (!in_array((int)$params['product'],$listProductId))) {
			if ($isBundleProduct && (!isset($params['bundle_option']))) {
